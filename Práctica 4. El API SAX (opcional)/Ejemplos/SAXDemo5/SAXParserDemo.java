...
// Importar algunas de las extensiones SAX
...
//public class MiResolver implements EntityResolver {
//  public InputSource resolveEntity (String pubId, String sysId)
//            throws SAXException, java.io.IOException {
//    if (pubId.equals("-//cgosorio//DTD receta//ES")) {
//      // devuelve un InputSource a una DTD local
//      java.io.File f = new java.io.File("DTDs/receta.dtd");
//      InputSource inso = InputSource( f.toURL().toString() );
//      inso.setPublicId(pubId);
//      return inso;
//    } else // usar el funcionamiento por defecto
//      return null;
//  }
//}
...
class MyContentHandler implements ContentHandler {
     ...
     * retrollamdas ocurren which provides
     * </p>
     *
     ...
     * la &uacute;nica expceci&oacute;n de <code>{@link #setDocumentLocator}</code>.
     * </p>
     *
     ...
     *     distinta de la decalraci&oacute;n XML.
     * </p>
     *
    ...
    public void startElement(String namespaceURI, String localName,
        ...
        for (int i=0; i<atts.getLength(); i++) {
            System.out.println(" Atributo: " + atts.getLocalName(i) +
                "=" + atts.getValue(i)+"("+atts.getType(i)+")");
        }
    }
...
/**
 * <b><code>MyErrorHandler</code></b> implementa la interfaz SAX
 *   <code>ErrorHandler</code> y define el comportamiento de 
 *   las retrollamadas SAX asociadas a la apareici&oacute;n de 
...
class MyDeclHandler implements DeclHandler {
 ...
 System.out.println("attributeDecl( " + eName + ", " + aName + ", " +
